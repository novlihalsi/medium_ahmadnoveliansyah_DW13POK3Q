  ...
  render() {
    return(
      <div style={{display:'flex', justifyContent:'center', flexDirection:'row'}}>
        <div style={{ display:'flex', justifyContent:'center', textAlign:'center', margin:'180px 300px 0 300px'}}>
          <div style={{flex:1}}>
          ...
          <div style={{flex:1, padding:'20px 100px 50px 100px'}}>
            <div>
              <Typography variant="h4" style={{marginBottom:20, fontWeight:'bold'}}>Join medium.</Typography>
              <Typography style={{marginBottom:15}}>Create an account to receive great stories in your inbox, personalize your homepage, and follow authors and topics that you love.</Typography>
            </div>

            <div>
            <TextField  label="Username" style={{width:300, marginBottom:20}}/>
            <TextField style={{width:300, marginBottom:20}}
              label="Password"
              type="password"
            />
            <TextField  label="Email" style={{width:300, marginBottom:20}}/>
            </div>
