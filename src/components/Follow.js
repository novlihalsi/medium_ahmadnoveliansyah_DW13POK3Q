    ...
    <Grid container style={{ marginTop: 20, marginBottom: 60 }}>
      ...
      <Grid item xs={3}>
        <div style={{ display: "flex", flexDirection: "row", marginTop: 30 }}>
          <Button variant="outlined" style={{ margin: "auto", color: "green" }}>
            Follow
          </Button>
        </div>
      </Grid>
...
class Follow extends Component {
  render() {
    ...
    const id = this.props.idarticles;
      ...
      <div>
        ...
        <Grid container style={{ marginTop: 20 }}>
          <Grid item xs={1} style={{ alignItems: "center" }}>
            <IconButton>
              <img
                src="https://image.flaticon.com/icons/svg/1313/1313777.svg"
        ...
        {comment.slice(0, 2).map(item => (
          <Showcomment
            ...
            name={item.usersComment.fullname}
          />
        ))}
        {/* <showComment /> */}
        ...
        {/* <Grid container style={{ marginTop: 20, marginBottom: 60 }}>
          ...
          <Grid item xs={7}>
            <div>
              ...
              <Typography style={{ color: "grey", fontSize: 15 }}>
                Helping leaders tell strategic stories. Ex @skype @mashery
                @timeinc http://andyraskin.com
              </Typography>
            </div>
          </Grid>
          <Grid item xs={3}>
        ...
        {/* <Grid container style={{ marginBottom: 20 }}>
          <Grid item xs={2} style={{ alignItems: "center" }}>
            <IconButton>
              <Avatar
                src="https://miro.medium.com/fit/c/80/80/1*kFWwYehzjJIhgw8hTygfHw.png"
                style={{ width: 80, height: 80 }}
              />
            </IconButton>
          </Grid>
        ...
        >
          ...
          >
            <Button variant="outlined" style={{ height: 50, color: "green" }}>
              See Responses ({comment.length})
            </Button>
          </Link>
        </div>
      </div>
